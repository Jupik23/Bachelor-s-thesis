...
from app.crud.healthform import (create_health_form_crud, 
    get_health_form_by_user_id, update_health_form
)
...
class HealthFormService:
    ...
    def update_health_form(self, user_id: int, new_input_data: HealthFormUpdate):
        return update_health_form(self.db, user_id, new_input_data)